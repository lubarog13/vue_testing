  ...
  <div class="calendar">
    <div class="calendar__header">
      ...
      <div class="calendar__header__actions actions">
        <b-button class="back" @click="addMonth(-1)"
          ><img class="icon" :src="require('/src/assets/icons/Arrow.svg?data')"
        /></b-button>
        <b-button class="forward" @click="addMonth(1)"
          ><img class="icon" :src="require('/src/assets/icons/Arrow.svg?data')"
        /></b-button>
      </div>
    </div>
    <div class="calendar__weekdays">
      <div
        class="calendar__weekdays__weekday"
    ...
    <div class="calendar__body">
      <div
        class="calendar__body__day calendar__day"
        v-for="day in days"
        :key="day.date"
        :class="{
      ...
      >
        ...
        />
        <span
          v-if="day.event === 'Лекция+Практика'"
          class="calendar__day__double_event"
        />
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    dayEvent(date) {
      const day = this.eventDays.filter(
