<template>
    <div class="badge">
        <div class="badge__content" :class="{'badge-active': active}">
            <div class="badge__title custom-badge" :id="id" @mouseover="active=true" @mouseleave="active=false"
                :class="{
                    'orange-badge': variant==='orange',
                    'blue-badge': variant==='blue'
                }"
            >
                {{title}}
            </div>
                <div class="arrow_up"  v-show="active">
                </div>
                <b-tooltip :target="id" triggers="hover" placement="bottom" variant="success">
                    {{text}}
                </b-tooltip>
                </div>
            </div>
...
.badge {
    ...
    &__content {
        ...
        .blue-badge {
            background: @primary5-blue-color;
            color: @primary-blue-color;

            &:hover {
                background: @primary-blue-color;
                color: @primary5-blue-color;
            }
        }
    }
}
