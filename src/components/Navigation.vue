    ...
    <div class="navigation__content">
      ...
      <div class="navigation__main main">
        ...
        <div class="main__date date">
          ...
          <div class="date__week">чётная неделя</div>
        </div>
        <div class="main__notifications">
          <img
            src="../assets/icons/notification-outline-active.svg"
            class="icon"
          />
        </div>
        <div class="main__profile profile">
          ...
          <div class="profile__content">
            <div class="profile__name">
              {{
                `${profileLastName} ${profileFirstName.charAt(
                  0
                )}. ${profileSecondName.charAt(0)}.`
              }}
            </div>
...
export default {
  ...
  computed: {
    ...
    ...mapState({
      ...
      profilePhoto: (state) =>
        require(`../assets/images/${state.profile.profilePhoto}`),
      countryPhoto: (state) =>
        require(`../assets/countryIcons/${state.country}.png`),
    }),
  },
};
</script>
